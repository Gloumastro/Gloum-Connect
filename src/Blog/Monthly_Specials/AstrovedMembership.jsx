...
const AstrovedMembership = () => {
    return (
        <>
            ...
            <Box sx={{ height: { xs: "auto", lg: "145vh" }, width: "100%", background: "#62CCDF" }}>
                <Typography sx={{
                ...
                <Box sx={{
                    ...
                    <Box sx={{ height: { xs: 'auto', sm: 'auto', lg: '60vh' }, width: { xs: '100%', sm: '48%', lg: '31%' }, borderRadius: '1rem', background: 'white' }}>
                ...
                <Box sx={{
                    ...
                    <Box sx={{ height: { xs: 'auto', sm: 'auto', lg: '56vh' }, width: { xs: '90%', sm: '100%', lg: '48%' }, borderRadius: '1rem', background: 'white',margin:"auto" }}>
